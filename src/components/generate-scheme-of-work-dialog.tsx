...
import { Loader2, Save, Copy, Calendar, FileDown } from "lucide-react";
...
export default function GenerateSchemeOfWorkDialog({ open, onOpenChange, onResourceSaved }: GenerateSchemeOfWorkDialogProps) {
  ...
  const handleExportPDF = () => {
      ...
      <html>
        <head>
          ...
          <style>
            ...
            th, td { border: 1px solid #000; padding: 8px; text-align: left; vertical-align: top; font-size: 10px; word-wrap: break-word; }
            ...
            .meta { margin-bottom: 25px; display: grid; grid-template-columns: 1fr 1fr; gap: 10px; font-size: 13px; }
            .meta p { margin: 2px 0; }
            @media print {
              body { padding: 0; }
        ...
        <body>
          ...
          <div style="margin-top: 30px; font-size: 10px; color: #666; text-align: center; border-top: 1px solid #eee; padding-top: 10px;">
            Generated by SyncSenta AI Educational OS
          </div>
        </body>
      </html>
    `);
    ...
    windowWin.focus();
    // Delay slightly to ensure fonts/styles load in some browsers
    setTimeout(() => {
      windowWin.print();
      windowWin.close();
    }, 250);
